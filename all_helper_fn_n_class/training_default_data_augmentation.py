...
def get_patch_size(final_patch_size, rot_x, rot_y, rot_z, scale_range):
    ...
    from batchgenerators.augmentations_utils import rotate_coords_3d, rotate_coords_2d
...
if __name__ == "__main__":
    from training_dataloading_dataset_loading import DataLoader3D, load_dataset
