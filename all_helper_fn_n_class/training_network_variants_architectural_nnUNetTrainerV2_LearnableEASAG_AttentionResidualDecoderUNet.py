...
import numpy as np
import torch
from all_helper_fn_n_class.network_architectures_LEASAG_Attention_ResidualDecoder_UNet import LearnableEASAGResidualDecoderAttentionUNet, get_default_network_config
...
class nnUNetTrainerV2_Larnable_EASAG_Residual_DecoderUNet(nnUNetTrainerV2):
    ...
    def initialize_network(self):
        ...
        self.network = LearnableEASAGResidualDecoderAttentionUNet(input_channels=self.num_input_channels, base_num_features=self.base_num_features,
