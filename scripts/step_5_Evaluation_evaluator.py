...
sys.path.append(os.path.abspath('/home/ss_students/zywx/main_file/all_helper_fn_n_class/batchgenerators'))
...
class Evaluator:
    ...
    """
    # print("[DEBUG] Defined Evaluator class")
...
reference_folder = '/home/ss_students/zywx/inference_result/label'
prediction_folder = '/home/ss_students/zywx/inference_result/prediction'
label_ids = [1]
